...
Class Jcrop {
    ...
    public function set_data($set) {
        if (is_array($set)) {
            if (array_key_exists('prefix', $set)) {
                $this->prefix = $set['prefix'];
            };
            if (array_key_exists('folder', $set)) {
                $this->folder = $set['folder'];
            };
            if (array_key_exists('target_w', $set)) {
                $this->target_w = $set['target_w'];
            };
            if (array_key_exists('target_h', $set)) {
                $this->target_h = $set['target_h'];
            };
            if (array_key_exists('create_thumb', $set)) {
                $this->create_thumb = $set['create_thumb'];
            };
            if (array_key_exists('thumb_folder', $set)) {
                $this->thumb_folder = $set['thumb_folder'];
            };
        } else {
...
/* End of file jcrop.php */
/* Location: ./application/libraries/jcrop.php */