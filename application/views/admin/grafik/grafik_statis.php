...
// Fixes bug in fp9
    ...
    <body>
        ...
        $FC = new FusionCharts("Column2D", "800", "350");

        # Setting Relative Path of chart swf file.
        $FC->setSwfPath("Charts/");

        # Store chart attributes in a variable
        $strParam = "caption=Grafik Penjualan Buku (berdasarkan judul buku); xAxisName=<br/>Judul Buku ;yAxisName=<b>Jumlah</b>;decimalPrecision=0; formatNumberScale=0";

        # Set chart attributes
        $FC->setChartParams($strParam);

        # add chart values and category names
        $FC->addChartData("20", "name=Remirezs dear");
        $FC->addChartData("19", "name=Setahun Berkisah");
        $FC->addChartData("120", "name=Syariah Hijab");
        $FC->addChartData("200", "name=Hujan dan Pelangi");
        $FC->addChartData("123", "name=Komik Band Koplak");
        # Render Chart
        $FC->renderChart();
        ?>
