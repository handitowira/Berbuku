            ...
            <form accept-charset="utf-8" action="<?php echo base_url(); ?>template/palmtree/contact-us-error.php" method="post" style="width: 100%;" novalidate><input type="hidden" name="1a8631e2fbb58b399c91e8a2391cc872bbb0e068" value="533212f6fcbd66a8381444c182b81c0f0e1bd63714e93b4e7706d685a16b6b3e" /><p class="form">Name:  <br /><input type="text" class="form"  name="name" value="" /></p><p class="form">E-Mail: <span style="font-weight: bolder; color: red;">*</span> <br /><input type="email" class="form"  name="email" value="" /></p><p class="form">Message: <span style="font-weight: bolder; color: red;">*</span> <br /><textarea name="nachricht" rows="9" class="form"></textarea></p>
                <table style="width: 100%;border: none;border-spacing: 0px;">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="sicherheitscode" class="captcha" size="6" maxlength="5">
                        </td>
                    </tr>
                </table>
                <div id="bottom">
