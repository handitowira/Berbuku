...
(function ($) {
    ...
    $.fn.addmultizoom = function (options) {
        ...
        function loadfunction() {
            var lnk = this,
                styleobj1 = {}, styleobj2 = {}, $nim, lnkd, lnkt, lnko, w, h;
        ...
        this.click(function (e) {
            ...
            $imgObj.data('added') && $imgObj.stop(true, true).data('added').not('.zoomtracker').remove().end()
                .css({
    ...
    $.extend(featuredimagezoomer, {
        ...
        showimage: function ($tracker, $mag, showstatus) {
            ...
            specs.$statusdiv.html('Current Zoom: ' + specs.curpower + '<div style="font-size:80%">Gunakan Scroll Pada Mouse untuk Zoom in/out</div>');
    ...
    $.fn.addimagezoom = function (options) {
        ...
        if (options.multizoom !== null && ($thumbs).size()) {
            ...
            return this.each(function () {
                if (this.tagName !== featuredimagezoomer.iname) return true; //skip to next matched element
